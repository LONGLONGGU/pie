...
public class CodeGeneratorMyBatisPlus {
    ...
    public static void main(String[] args) {
        String dataSourceUrl = "jdbc:mysql://127.0.0.1:3306/zst-sina?useUnicode=true&zeroDateTimeBehavior=convertToNull&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
        String dataSourceName = "root";
        String dataSourcePassword = "root";
        String dataSourceDriver = "com.mysql.cj.jdbc.Driver";
        String tables = "bus_public_sentiment_content"; //需要生成的表名，多张表用英文逗号隔开
        String packageParent = "com.framework.pie.sina";
        String codePath = "/Users/longlong/working/file/";
