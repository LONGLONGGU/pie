...
public class CodeGeneratorMyBatisPlus {
    ...
    public static void generate(String dataSourceUrl, String dataSourceName, String dataSourcePassword, String dataSourceDriver,
        ...
        gc.setActiveRecord(true); //活动记录 不需要ActiveRecord特性的请改为false 是否支持AR模式
    ...
    public static void main(String[] args) {
        String dataSourceUrl = "jdbc:mysql://localhost:3306/pie?useUnicode=true&zeroDateTimeBehavior=convertToNull&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
        String dataSourceName = "root";
        String dataSourcePassword = "111111";
        String dataSourceDriver = "com.mysql.cj.jdbc.Driver";
        String tables = "sys_user"; //需要生成的表名，多张表用英文逗号隔开
        String packageParent = "com.framework.pie.testInfo";
