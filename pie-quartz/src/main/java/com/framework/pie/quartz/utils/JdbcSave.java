...
public class JdbcSave {
    ...
    public static void loadConfig() {
        try {
            ...
            //USERNAME =s.decDbUp(prop.getProperty("jdbc.username"));
            //PASSWORD =s.decDbUp(prop.getProperty("jdbc.password"));
    ...
    public Connection getConnection() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://172.16.1.131:3306/zst?useUnicode=true&zeroDateTimeBehavior=convertToNull&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8", "root", "Ynzsj@Zst#0871"); // 获取连接
        } catch (Exception e) {
    ...
    public void demoBath(List<String> list){
        try {
